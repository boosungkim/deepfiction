        ...
        <div className="group-hover:flex flex-col max-h-[94%] hidden absolute bottom-0 left-0 right-0 bg-[#10131f] m-2 p-4 rounded-md">
          ...
          <div className="mt-5 flex justify-between items-center gap-2">
            <div className="flex items-center gap-2">
              <div className="w-7 h-7 rounded-full onject-cover bg-green-700 flex justify-center items-center text-white text-xs fond-bold">
                {name[0]}
              </div>
