...
const Home = () => {
  ...
  const handleSearchChange= (e) => {
    ...
    setSearchTimeout(
      setTimeout(() => {
        const searchResults = allStories.filter((item) => item.name.toLowerCase().includes(searchText.toLowerCase()) || item.prompt.toLowerCase().includes(searchText.toLowerCase()));
